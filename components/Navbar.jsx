			...
			<div class="container flex flex-wrap justify-center items-center mx-auto">
				...
				<form className="w-full sm:w-1/2">
					...
					<div class="relative">
						...
						<button
							type="submit"
							class="text-gray-300 absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 bg-opacity-70 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
						>
							Search
						</button>
					</div>
